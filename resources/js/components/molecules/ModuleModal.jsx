        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-surface w-full max-w-md rounded-lg shadow-xl overflow-hidden flex flex-col">
                <div className="px-6 py-4 border-b border-outline-variant flex justify-between items-center bg-surface-container-lowest">
                    <h3 className="font-headline-sm text-primary">{initialData ? 'Edit Module' : 'Add Module'}</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 flex-1 overflow-y-auto bg-surface-container-lowest">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label className="block font-label-md text-on-surface">Module Title <span className="text-error">*</span></label>
                            <input 
                                type="text" 
                                value={title} 
                                ...
                                required 
                                autoFocus
                                placeholder="e.g. Introduction to Green Business"
