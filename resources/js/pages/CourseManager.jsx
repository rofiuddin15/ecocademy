    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h2 className="font-headline-xl text-headline-xl text-primary">Course Management</h2>
                    <p className="font-body-md text-on-surface-variant mt-2">Manage your greenpreneur courses, modules, and quizzes.</p>
                </div>
                <Link 
                    to="/dashboard/manager/create"
                    className="bg-primary text-white px-6 py-3 rounded-lg font-label-md text-label-md hover:bg-primary/90 transition-colors flex items-center gap-2 shadow-sm"
                >
                ...
                {courses.map(course => (
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="font-headline-md text-primary mb-1 group-hover:text-primary transition-colors">{course.title}</h3>
                            <p className="text-on-surface-variant font-body-sm line-clamp-2">{course.description}</p>
                        </div>
                        <div className="flex items-center gap-2 text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                            <span className="font-label-md">View Details</span>
