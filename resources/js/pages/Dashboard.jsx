                ...
                <div className="col-span-12 lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-white p-8 rounded-xl border border-outline-variant shadow-sm">
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4 p-3 rounded-lg hover:bg-surface-container transition-colors group">
                                <div className="flex-shrink-0 w-12 h-12 bg-secondary-fixed text-on-secondary-fixed-variant rounded-md flex flex-col items-center justify-center">
                                    <span className="font-label-md text-label-md leading-none font-bold">24</span>
                                    <span className="text-[10px] uppercase font-bold">Oct</span>
                                </div>
                                <div>
                                    <h4 className="font-label-md text-label-md text-on-surface group-hover:text-secondary transition-colors font-bold">Phase 2: Waste Map</h4>
                                    <p className="font-label-sm text-label-sm text-on-surface-variant">Kuliner Sehat Project</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-3 rounded-lg hover:bg-surface-container transition-colors group">
                                <div className="flex-shrink-0 w-12 h-12 bg-surface-container text-on-surface-variant rounded-md flex flex-col items-center justify-center">
                                    <span className="font-label-md text-label-md leading-none font-bold">28</span>
                                    <span className="text-[10px] uppercase font-bold">Oct</span>
                                </div>
                                <div>
                                    <h4 className="font-label-md text-label-md text-on-surface group-hover:text-secondary transition-colors font-bold">Module Quiz 03</h4>
                                    <p className="font-label-sm text-label-sm text-on-surface-variant">Sustainable Product Design</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-3 rounded-lg hover:bg-surface-container transition-colors group">
                                <div className="flex-shrink-0 w-12 h-12 bg-surface-container text-on-surface-variant rounded-md flex flex-col items-center justify-center">
                                    <span className="font-label-md text-label-md leading-none font-bold">02</span>
                                    <span className="text-[10px] uppercase font-bold">Nov</span>
                                </div>
                                <div>
                                    <h4 className="font-label-md text-label-md text-on-surface group-hover:text-secondary transition-colors font-bold">Peer Review Session</h4>
                                    <p className="font-label-sm text-label-sm text-on-surface-variant">Green Showcase prep</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-primary-container rounded-xl p-8 text-primary-fixed relative overflow-hidden">
                        ...
                        <p className="font-body-md text-body-md opacity-80 mb-6 relative z-10 text-slate-300">
                            Meet the founders of 'Kuliner Sehat' and see their journey.
                        </p>
