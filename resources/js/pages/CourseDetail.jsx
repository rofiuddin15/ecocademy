...
const CourseDetail = () => {
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-2xl border border-outline-variant/30 overflow-hidden shadow-sm mb-8 grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {course.modules?.length === 0 ? (
                        ...
                        course.modules
                            ...
                            .map((module, idx) => (
                                <div key={module.id} className="bg-white rounded-xl border border-outline-variant/30 overflow-hidden shadow-sm">
                                    {/* Module Top Bar */}
                                                            ...
                                                            {module.materials
                                                                ...
                                                                .map((material) => (
                                                                    <button
                                                                        ...
                                                                        className="w-full flex items-center justify-between p-4 hover:bg-surface-container-low/50 text-left transition-colors cursor-pointer bg-white"
                                                                    >
            ...
            {selectedMaterial && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl overflow-hidden max-h-[85vh] flex flex-col">
                        {/* Modal Header */}
